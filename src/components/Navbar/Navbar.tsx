...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-200 shadow-2xl border-gray-200 text-black ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div className="flex gap-3">
          ...
          <div
            ...
            id="navbar-user"
          >
            <ul className="  flex   bg-white rounded-xl">
              <li>
                <Link
                  to="/products/1"
        ...
        <div
          className={`items-center    justify-between ${
            isDropdownMenu ? "flex max-md:absolute max-md:top-[4.5rem] max-md:shadow-lg max-md:left-0 max-md:w-full max-md:items-center bg-white " : "hidden "
          }   w-full md:flex md:w-auto`}
          id="navbar-user"
        >
          <ul className="flex z-50 flex-col w-full font-medium p-4 md:p-0 mt-4    rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white ">
            <li>
              <Link
                to="/products/1"
                className="block py-2 pl-3 pr-4 text-black rounded md:bg-transparent "
